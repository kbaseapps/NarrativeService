...
/**
 * <p>Original spec-file type: LogOpenParams</p>
 * 
 * 
 */
...
public class LogOpenParams {
    ...
    public LogOpenParams withContext(LogContext context) {
        this.context = context;
        return this;
    }
    ...
    public String toString() {
        return ((((("LogOpenParams"+" [context=")+ context)+", additionalProperties=")+ additionalProperties)+"]");
    }
